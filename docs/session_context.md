...
*   **Checklist State**: Located at [checklist.md](file:///d:/cold-mail/RepoProof/docs/checklist.md) (All items currently pending).
...
3.  **Write Foundation Files**:
    *   `/backend/pyproject.toml` (FastAPI, uvicorn, celery, redis, sqlalchemy, alembic, pgvector, pydantic, langgraph).
